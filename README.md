...
<p align="center">
  ...
  <a href="https://linkedin.com/in/pubudugunasekara">
...
|---|---|---|
| 🤖 AI Code Review Assistant | Node.js · GPT-4o · React · Redis | 🟡 Week 1 |
| ⚙️ Distributed Task Scheduler | Java · Kafka · Redis · Grafana | 🔵 July |
| 📡 ML Anomaly Detection | Python · FastAPI · React Native · TF | 🔵 August |

### 🛠 Stack
`Java` `Spring Boot` `React` `Node.js` `Kafka` `Docker` `Kubernetes` `Python` `AWS`

### 💼 Previously
**SDET @ Virtusa** — British Telecom project · 1M+ users · 80% test time reduction

### 📊 This Week's LeetCode Target
Arrays · HashMap · Two Pointers — building the foundation
